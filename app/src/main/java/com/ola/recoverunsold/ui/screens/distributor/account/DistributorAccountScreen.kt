    ...
    Scaffold(
        ...
        Column(
            ...
            DistributorProfileInformationSection(
                ...
                loading = distributorAccountViewModel.accountUpdateApiCallResult.status == ApiStatus.LOADING,
            ...
            if (distributorAccountViewModel.accountUpdateApiCallResult.status == ApiStatus.SUCCESS) {
...
class DistributorAccountViewModel(
    ...
    fun updateDistributor() {
        ...
        accountUpdateApiCallResult = ApiCallResult.Loading()
        viewModelScope.launch {
            ...
            accountUpdateApiCallResult = if (response.isSuccessful) {
    ...
    fun errorMessage(): String? = when (accountUpdateApiCallResult.statusCode) {
